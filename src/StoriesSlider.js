        ...
        <div class="player">
          <div class="player-wrapper">
              ...
              <div class="player-wrapper__chunk-wrp">
                ${this.getStoryItemTypeTemplate(item)}
                ${this.getStoryGoodsLinkTemplate(item.prod, story.name)}
              </div>
...
getStoryGoodsLinkTemplate(prod, name) {
    return `
      <div class="stories-goods">
          <a class="stories-goods__link" href="${prod}">${'Товар ' + name}</a>
      </div>`
  }
